...
to factors.  However, make sure the "Month" variable is an ordered factor. This
may require you to do two seperate `mutate()` statements.
...
other variables in our data set?  Hint: use `n_distinct()` inside `summarize_if()`
